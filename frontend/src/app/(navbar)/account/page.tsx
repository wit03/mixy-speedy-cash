...
const Account = () => {
    ...
    return (
        <>
            ...
            <Link href={"/show-loan"} className="flex m-5 font-rubik justify-between items-center">
            ...
            <Link
            href={"/login"} 
            onClick={() => toast.success("Success to logout")}
            className="mr-4 float-end hover:opacity-95 mx-auto relative px-4 py-2 mt-4  bg-gradient-to-r from-[#a6c1ee] to-[rgba(122,93,186,0.2)] border border-solid border-ded4f5 box-border rounded-md text-white text-14 tracking-0.02 font-bold text-center inline-block">
                Logout
            </Link>
        </div>
            }
